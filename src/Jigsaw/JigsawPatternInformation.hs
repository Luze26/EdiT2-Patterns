...
themes = [Theme{name="t1", resources = ["r1", "r2"], nbExpert=1, lowerMargin = 0, upperMargin = 0, nbResources = 1},
	Theme{name="tg", resources = ["bhu", "r2"], nbExpert=2, lowerMargin = 0, upperMargin = 0, nbResources = 2},
	Theme{name="te", resources = ["zz", "aa"], nbExpert=1, lowerMargin = 0, upperMargin = 1, nbResources = 2}] 
...
participantObjectsList = [("etu1","","","","",""), ("etu2","","","","",""), ("etu3","","","","",""), ("etu4","","","","",""), ("etu5","","","","","")]
